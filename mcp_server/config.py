...
"""
Enterprise AI Multi-Agent 서버 설정
- 6개 전문 Agent: Email, CRM, Calendar, CS, Helpdesk, Report
- 포트: 9000 (MCP), 9001 (Log API), 9501 (Dashboard)
...
# ============================================================
MCP_PORT = int(os.getenv('MCP_PORT', '9000'))        # MCP Server
LOG_API_PORT = int(os.getenv('LOG_API_PORT', '9001'))  # Log Receiver API
DASHBOARD_PORT = int(os.getenv('DASHBOARD_PORT', '9501'))  # Streamlit
